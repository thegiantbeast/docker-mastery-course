...
docker container run --rm --name jekyll -p 80:4000 -v $(pwd)/site:/site -d bretfisher/jekyll-serve > /dev/null
...
printf "\n## File changed on $dateString" >> $(pwd)/site/_posts/2017-03-05-welcome-to-jekyll.markdown
